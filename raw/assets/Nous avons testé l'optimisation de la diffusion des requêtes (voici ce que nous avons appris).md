...
created: 2026-06-15
description: "Nous avons optimisé les requêtes de type « fan-out » pour voir si cela améliore notre visibilité en matière d'IA. Lisez cet article pour savoir ce qui s'est passé."
tags:
  - "clippings"
---
Nous avons traduit cet article de l'anglais. [Clique ici](https://www.semrush.com/blog/query-fan-out-experiment/) pour lire l'article original. Si tu remarques des problèmes dans le contenu, n'hésite pas à nous contacter à [report-osteam@semrush.com](mailto:report-osteam@semrush.com).
...
Une idée consiste à optimiser pour [la diffusion de requêtes](https://www.semrush.com/blog/query-fan-out/). Le processus de multiplication des requêtes consiste à décomposer votre requête de recherche initiale en plusieurs sous-requêtes, puis à collecter des informations provenant de diverses sources afin de construire une réponse complète.

Cette illustration représente parfaitement le processus de diffusion des requêtes.

![Illustration du processus de diffusion des requêtes](https://static.semrush.com/blog/uploads/media/27/58/2758a9c35c1141a428543423448661fa/f5090501d28bda7a2f8a5c0a372e386b/original.png)

Illustration du processus de diffusion des requêtes
...
- **Les citations d'IA peuvent être imprévisibles**: J'ai vérifié périodiquement au cours du mois, et à un moment donné, nos citations sont montées jusqu'à neuf avant de retomber à cinq. Il y a eu [rapports](https://www.linkedin.com/posts/niklas-buschner_chatgpt-dropped-90-of-citations-overnight-activity-7375561708133728256-fZ4a?) de ChatGPT réduisant drastiquement les citations pour les marques et les éditeurs dans tous les domaines. Cela montre simplement à quelle vitesse les choses peuvent changer lorsqu'on s'appuie sur des plateformes d'IA pour obtenir une visibilité.
...
- J'ai fait équipe avec [Tushar Pol](https://www.semrush.com/blog/user/203456689/), un rédacteur de contenu senior de notre équipe, pour m'aider à exécuter les changements de contenu pour cette expérience. Il a remanié le contenu de nos articles afin de répondre au plus grand nombre possible de questions posées par nos fans.
- J'ai mis en place un système de suivi des requêtes de diffusion afin de pouvoir mesurer la visibilité avant et après l'intervention de l'IA. J'ai utilisé la plateforme Semrush [Enterprise AIO](https://www.semrush.com/lp/enterprise-aio/en/) pour cela. Nous étions principalement intéressés par l'impact de nos modifications de contenu sur la visibilité dans le mode IA de Google, mais nos optimisations pouvaient également améliorer la visibilité sur d'autres plateformes comme ChatGPT Search, c'est pourquoi j'ai également suivi les performances sur ces plateformes.
...
1. [Un guide sur la création d'un calendrier marketing](https://www.semrush.com/blog/marketing-calendar/)
2. [Explication de ce que sont les sous-domaines et de leur fonctionnement](https://www.semrush.com/blog/what-is-a-subdomain/)
3. [Un guide complet sur le classement des mots clés Google](https://www.semrush.com/blog/google-keyword-ranking/)
4. [Un guide détaillé sur la manière de réaliser des audits techniques SEO](https://www.semrush.com/blog/technical-seo-audit/)
...
Tout d'abord, j'ai utilisé [Grenouille hurlante](https://www.screamingfrog.co.uk/). Le script analyse le contenu de la page, identifie le mot-clé principal ciblé, puis effectue sa propre version de diffusion de requêtes pour suggérer des requêtes connexes.

![Tableau de bord Screaming Frog avec la colonne « Query Fan-Out » mise en évidence.](https://static.semrush.com/blog/uploads/media/6f/54/6f54a4f5b8708f5839241b0d876f4ad3/32d6a6d119433918859d7eee0ed43b95/original.png)

Tableau de bord Screaming Frog avec la colonne « Query Fan-Out » mise en évidence.
...
![Données de diffusion de requêtes générées sur Screaming Frog et collées dans une feuille Google.](https://static.semrush.com/blog/uploads/media/f9/8c/f98ca16a2d516b01eba8d7309dfdcbfe/359704abdcb9ddea556d2215e1a54426/original.png)

Données de diffusion de requêtes générées sur Screaming Frog et collées dans une feuille Google.
...
Ensuite, j'ai utilisé [Qforia](https://qforia.streamlit.app/), un outil gratuit créé par [Mike King](https://www.linkedin.com/in/michaelkingphilly) et son équipe chez iPullRank.
...
![Tableau de bord Qforia avec une requête saisie, le mode de recherche sélectionné et l'option « Exécuter la diffusion » sélectionnée, ce qui génère une liste de requêtes associées.](https://static.semrush.com/blog/uploads/media/40/66/4066ca50ad0c70e9f8e7bd98aa9ea281/e2f33cf340ec464219c47981435e9653/original.png)

Tableau de bord Qforia avec une requête saisie, le mode de recherche sélectionné et l'option « Exécuter la diffusion » sélectionnée, ce qui génère une liste de requêtes associées.
...
![Un article de blog sur Semrush contenant un paragraphe, mis en évidence, où une requête de type « fan-out » pourrait être abordée.](https://static.semrush.com/blog/uploads/media/35/82/358250e87a66b26491f6d4c695f4b0b2/f063d35e364c7610c662652f4c8b4938/original.png)

Un article de blog sur Semrush contenant un paragraphe, mis en évidence, où une requête de type « fan-out » pourrait être abordée.
...
![Section FAQ d'un article de blog abordant de nombreuses questions relatives à la diffusion.](https://static.semrush.com/blog/uploads/media/9d/77/9d77927f72a6979a5d02d555f6946ec0/e84fe646081d170107f4bd10225f97d1/original.png)

Section FAQ d'un article de blog abordant de nombreuses questions relatives à la diffusion.
...
![Tableau de bord Enterprise AIO affichant une liste d'invites ainsi que l'option « Publier le projet » sélectionnée.](https://static.semrush.com/blog/uploads/media/86/c7/86c7e53ba594cda29ad24ea98e1a90a5/c00ce805ea0850d7d956c74f753994d6/original.png)

Tableau de bord Enterprise AIO affichant une liste d'invites ainsi que l'option « Publier le projet » sélectionnée.
...
![Indicateurs de performance de base pour une expérience de diffusion de requêtes : citations, nombre total de mentions, part de voix, visibilité de la marque.](https://static.semrush.com/blog/uploads/media/76/db/76dba9e82199e98764e1d32ce68881be/b3f5fa5d506afb99e28fb37041abb576/original.png)

Indicateurs de performance de base pour une expérience de diffusion de requêtes: citations, nombre total de mentions, part de voix, visibilité de la marque.
...
![Le tableau de bord de l'outil Enterprise AIO affichant les positions de l'IA et les détails de la réponse Prompt & .](https://static.semrush.com/blog/uploads/media/23/68/2368c83197e4e30423065b5e22d2b66e/3036ce10cbc47b2a31f9f2d677c68c76/original.png)

Le tableau de bord de l'outil Enterprise AIO affichant les positions de l'IA et les détails de la réponse Prompt &.
...
![Baisse de la part de voix sur les plateformes d'IA pour de nombreuses marques comme Ahrefs, Semrush, HubSpot, etc.](https://static.semrush.com/blog/uploads/media/63/65/6365d88c37235c6508bbe3b7a4ba3500/927d02a1b2cc1aca35176727e1abe989/original.png)

Baisse de la part de voix sur les plateformes d'IA pour de nombreuses marques comme Ahrefs, Semrush, HubSpot, etc.
...
- [Comment fonctionne réellement la recherche par IA: conclusions de notre étude sur la visibilité de l’IA](https://www.semrush.com/blog/ai-search-visibility-study-findings/)
- [Qu'est-ce que LLMs.txt? & Devriez-vous l'utiliser?](https://www.semrush.com/blog/llms-txt/)
- [Pourquoi votre marque est votre atout SEO le plus important en 2026](https://www.semrush.com/blog/seo-branding/)

Vous souhaitez surveiller la visibilité de votre IA?

Essayez Semrush Enterprise AIO